...
the camera image. In this case we used zero-mean Gaussian noise with
standard deviation of $1$. Note that we assumed we were able to
...
orientation $\overline{q}}_I^W(0)$ of the IMU were set with their
  ...
  $0.0349$ standard deviations, respectively. The latter case
  corresponds to about $8$ degrees of deviation, computed using
